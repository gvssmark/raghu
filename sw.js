...
var CACHE_VERSION = 'raghu-v11'; // bumped: fixed html/body height mechanism mismatch (documentElement.clientHeight was 47px short of window.innerHeight, exactly = safe-area-inset-top)
